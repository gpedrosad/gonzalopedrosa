...
const psicologo_bipolaridad_chillanFAQs = [
  {
    question: "¿La terapia reemplaza la medicación?",
    answer:
      "No. La medicación es fundamental en el trastorno bipolar. La terapia es un complemento que mejora los resultados, pero no sustituye el tratamiento farmacológico.",
  },
  {
    question: "¿Trabajan con mi psiquiatra?",
    answer:
      "Sí, cuando es necesario y con tu consentimiento, me coordino con tu psiquiatra para un tratamiento integral.",
  },
  {
    question: "¿Puedo ir aunque esté estabilizado/a?",
    answer:
      "Sí, de hecho es el mejor momento para trabajar prevención. Aprender a identificar señales tempranas puede evitar futuras crisis.",
  },
];

const breadcrumbItems = [
  { label: "Inicio", href: "/" },
  { label: "Psicólogo Bipolaridad Chillán" },
];

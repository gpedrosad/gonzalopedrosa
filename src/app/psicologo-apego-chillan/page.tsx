...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: getTwitterDescription("Psicólogo especializado en estilos de apego en Chillán. Terapia para entender tus patrones relacionales y construir vínculos más seguros."),
  },
};



const psicologo_apego_chillanFAQs = [
  {
    question: "¿Se puede cambiar el estilo de apego?",
    answer:
      "Sí. Aunque se forma en la infancia, el apego es modificable con experiencias correctivas y trabajo terapéutico. Puedes desarrollar un apego más seguro.",
  },
  {
    question: "¿Por qué siempre elijo parejas que me hacen mal?",
    answer:
      "Tendemos a buscar lo familiar, aunque sea dañino. Si creciste con vínculos inseguros, inconscientemente puedes buscar lo mismo en adultos.",
  },
  {
    question: "¿Cuánto dura este proceso?",
    answer:
      "Modificar patrones de apego es un trabajo profundo que toma tiempo. Generalmente varios meses, pero los cambios son significativos para toda tu vida.",
  },
];

const breadcrumbItems = [
  { label: "Inicio", href: "/" },
  { label: "Psicólogo Apego Chillán" },
];
  ...
  return (
    <>
      <OrganicSeoScripts
        ...
        faqs={psicologo_apego_chillanFAQs}
        serviceType="Psicología Apego"
        serviceDescription={"Psicólogo especializado en estilos de apego en Chillán. Terapia para entender tus patrones relacionales y construir vínculos más seguros."}
      />

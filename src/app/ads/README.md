...
Sitio chileno (`gonzalopedrosa.cl`). El copy de estas páginas —y del resto del sitio— va en **español de Chile (tuteo)**.

## Tono (no negociar)

- Tú / te / Escríbeme / Recupera / tienes / puedes / quieres / aceptas.
- **Prohibido el voseo argentino:** Recuperá, Escríbime, tenés, podés, querés, aceptás, Recuperás, Reconstruís, vivís, considerás, indicalo.
- No imperativos rioplatenses: hacé, dejá, contame, decime, andá.

Si un draft trae voseo, pasarlo a tuteo antes de publicar.

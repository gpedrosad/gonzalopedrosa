...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: getTwitterDescription("Psicólogo para ayudarte a tomar decisiones difíciles en Chillán. Terapia para clarificar opciones, superar la parálisis y decidir con confianza."),
  },
};



const psicologo_toma_decisiones_chillanFAQs = [
  {
    question: "¿Por qué no puedo simplemente decidir?",
    answer:
      "Las decisiones difíciles suelen involucrar emociones intensas, miedos al error, conflictos de valores o presiones externas. Todo eso dificulta la claridad mental.",
  },
  {
    question: "¿Cuántas sesiones necesito?",
    answer:
      "Depende de la complejidad. A veces basta con pocas sesiones para ganar claridad. Otras veces hay que trabajar más a fondo lo que subyace.",
  },
  {
    question: "¿Y si después me arrepiento?",
    answer:
      "El miedo al arrepentimiento es uno de los bloqueos más comunes. Trabajamos eso: tomar buenas decisiones con la información disponible y aceptar la incertidumbre.",
  },
];

const breadcrumbItems = [
  { label: "Inicio", href: "/" },
  { label: "Psicólogo Toma Decisiones Chillán" },
];
  ...
  return (
    <>
      <OrganicSeoScripts
        ...
        faqs={psicologo_toma_decisiones_chillanFAQs}
        serviceType="Psicología Toma Decisiones"
        serviceDescription={"Psicólogo para ayudarte a tomar decisiones difíciles en Chillán. Terapia para clarificar opciones, superar la parálisis y decidir con confianza."}
      />

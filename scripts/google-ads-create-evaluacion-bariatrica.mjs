...
const HEADLINES = [
  { text: "Pack bariátrico $75.000", pinned_field: enums.ServedAssetFieldType?.HEADLINE_1 ?? 1 },
...
const DESCRIPTIONS = [
  { text: "Pack $75.000: 2 sesiones de 50 min + informe PDF firmado + boleta. Online Chile." },
